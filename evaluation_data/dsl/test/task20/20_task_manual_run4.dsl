...
start_constraints:
  # --- 5.2 Dependency Matrix (initial branching & convergence at Order_Confirmation) ---
  ...
  # --- Customer notification, warehouse, quality, final processing, tax, doc, comp, archive, security (24 constraints) ---
  - from: 1   # PAYMENT_VALIDATION
  ...
  # --- Security/analytics/infrastructure & finalization (16 constraints) ---
